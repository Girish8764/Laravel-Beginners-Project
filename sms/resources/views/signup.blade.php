...
<body class="">
  <main class="main-content  mt-0">
    <div class="page-header align-items-start min-vh-50 pt-5 pb-11 m-3 border-radius-lg" style="background-image: url('../assets/img/register.png'); background-position: top;">
      <span class="mask bg-gradient-dark opacity-6"></span>
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5 text-center mx-auto">
            <h1 class="text-white mb-2 mt-5">Welcome!</h1>
            <h2 class="text-white mb-2 mt-5">Only For Schools</h2>
          ...
          <div class="card z-index-0">
            ...
            <div class="card-body">
                ...
                <form role="form" method="POST" action="{{ route('admin.register') }}">
                    @csrf
                    <div class="mb-3">
                        <input type="text" class="form-control" name="dice_code" placeholder="School DICE Code" aria-label="School DICE Code" required>
                    </div>
                    <div class="mb-3">
                        <input type="text" class="form-control" name="school_name" placeholder="School Name" aria-label="School Name" required>
                    </div>
                    <div class="mb-3">
                        <input type="email" class="form-control" name="email" placeholder="Email" aria-label="Email" required>
                    </div>
                    <div class="mb-3">
                        <input type="tel" class="form-control" name="mobile" placeholder="Mobile Number" aria-label="Mobile Number" pattern="[0-9]{10}" required>
                    </div>
                    <div class="mb-3">
